...
# Cualitativas: cuantos hay de cada
# Cuantitativas: summary
...
```{r, echo=FALSE}
boxplot(penguins$body_mass_g[penguins$species == "Adelie"] ~ penguins$island[penguins$species == "Adelie"], ylab = "Peso corporal", xlab = "Isla",col ="#7EC3E5")
medias = aggregate(penguins$body_mass_g[penguins$species == "Adelie"] ~ penguins$island[penguins$species == "Adelie"], FUN = mean)
...
par(mfrow = c(4, 1))
boxplot(penguins$flipper_length_mm ~ penguins$species, ylab = "Longitud aleta", xlab = "Especies", main = "Longitud de las aletas por especies",  col =c("#7EC3E5", "#E57E7E", "#8F7EE5"))
boxplot(penguins$bill_length_mm ~ penguins$species, ylab = "Longitud pico", xlab = "Especies",main = "Longitud del pico por especies",col =c("#7EC3E5", "#E57E7E", "#8F7EE5"))
boxplot(penguins$bill_depth_mm ~ penguins$species, ylab = "Longitud pico", xlab = "Especies",main = "Profundidad del pico por especies",col =c("#7EC3E5", "#E57E7E", "#8F7EE5"))
boxplot(penguins$body_mass_g ~ penguins$species, ylab = "Masa corporal", xlab = "Especies",main = "Masa corporal por especies",col =c("#7EC3E5", "#E57E7E", "#8F7EE5"))
par(mfrow = c(1, 1))
```
